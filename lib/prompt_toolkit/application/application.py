...
class Application(object):
    ...
    def run(self, pre_run=None, set_exception_handler=True, inputhook=None):
        ...
        def handle_exception(context):
            ...
            def print_exception():
                ...
                yield From(_do_wait_for_enter('Press Enter to continue or Ctrl+C to quit...'))  # Patched by Leistungsabfall
    ...
    def run_system_command(self, command, wait_for_enter=True,
                           display_before_text='',
                           wait_text='Press Enter to continue or Ctrl+C to quit...'):  # Patched by Leistungsabfall
        """
