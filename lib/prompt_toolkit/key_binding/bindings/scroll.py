...
def scroll_forward(event, half=False):
    ...
    if w and w.render_info:
        ...
        # old: y = b.document.cursor_position_row + 1
        y = b.document.cursor_position_row  # new
        height = 0
...
def scroll_backward(event, half=False):
    ...
    if w and w.render_info:
        ...
        # Calculate how many lines is equivalent to that vertical space.
        # Patched by Leistungsabfall
        # old: y = max(0, b.document.cursor_position_row) - 1
        y = max(0, b.document.cursor_position_row)  # new
        height = 0
        while y > 0:
            line_height = info.get_height_for_line(y)
