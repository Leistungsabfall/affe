import os, sys; sys.path.insert(0, os.path.join(os.path.dirname(__file__), os.path.pardir, 'lib'))
...
if __name__ == '__main__':
    ...
    if not args.headless and sys.platform == 'linux' and not os.getenv('AFFE_HEADLESS'):
        check_for_clipboard_manager()
    ...
    Globals.affe_emoji = random.choice(['🐵', '🙈', '🙉', '🙊', '🐒', '🦍', '🦧', '🍌'])
