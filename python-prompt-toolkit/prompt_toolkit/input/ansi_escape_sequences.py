...
ANSI_SEQUENCES = {
    ...
    '\x1b[1;3H': Keys.Ignore,  # AltHome
    '\x1b[1;3F': Keys.Ignore,  # AltEnd
    '\x1b[5;3~': Keys.Ignore,  # AltPageUp
    '\x1b[6;3~': Keys.Ignore,  # AltPageDown
    '\x1b[1;6D': Keys.Ignore,  # Control+Shift+Left
    '\x1b[1;6C': Keys.Ignore,  # Control+Shift+Right
    '\x1b[1;6A': Keys.Ignore,  # Control+Shift+Up
    '\x1b[1;6B': Keys.Ignore,  # Control+Shift+Down
}
